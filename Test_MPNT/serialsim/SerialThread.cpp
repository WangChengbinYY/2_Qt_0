...
//    cin >> portname;
    ...
    //    cout << "IMU File Path(7 columns, *.bin):" << endl;
    //    cin >> imufilename;
    //
    //    cout << "GNSS File Path(7 columns, *.txt):" << endl;
    //    cin >> gnssfilename;
    //
    //    cout << "NAV File Path(rtnav pack, *.rtnav):" << endl;
    //    cin >> navfilename;
...
void SerialThread::readGnssData(FILE *fp, GnssPack *gnsspack) {
    ...
    gnsspack->head2  = 0x55;
    gnsspack->week   = 0;
    gnsspack->time   = (unsigned int) lround(data[0]);
    gnsspack->lat    = data[1];
    gnsspack->lon    = data[2];
