...
//type,<1>time,<2>valid(1/0),<3>latitude(N 正 S 负),<5>longitude(E 正 W 负),<7>speed,<8>course,<9>date,
//<10>variation(E 正 W 负),
 ...
 */
enum minmea_sentence_id minmea_sentence_id(const char *sentence/*, uint8_t strict*/);
 ...
 */
uint8_t minmea_parse_rmc(struct minmea_sentence_rmc *frame, const char *sentence);
uint8_t minmea_parse_gga(struct minmea_sentence_gga *frame, const char *sentence);
uint8_t minmea_parse_gsa(struct minmea_sentence_gsa *frame, const char *sentence);
uint8_t minmea_parse_gll(struct minmea_sentence_gll *frame, const char *sentence);
uint8_t minmea_parse_gst(struct minmea_sentence_gst *frame, const char *sentence);
uint8_t minmea_parse_gsv(struct minmea_sentence_gsv *frame, const char *sentence);
uint8_t minmea_parse_vtg(struct minmea_sentence_vtg *frame, const char *sentence);
uint8_t minmea_parse_zda(struct minmea_sentence_zda *frame, const char *sentence);
