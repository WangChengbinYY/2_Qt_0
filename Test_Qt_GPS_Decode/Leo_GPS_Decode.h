...
/*--------------------------------------------------------------------------*/
//uint32_t G_Time_WeekSenconds;                         //GPS 周内秒，通过1pps校准
...
struct Leo_gps_data{
    ...
    struct minmea_float mHigh;                       //[注意：高程(是点 到地球椭球面的高度)= 点到水准面高度(海拔高度)+水准面到椭球面高度]
};
...
//<*    1 意味着目前存储的是一条完整的GPS语句，从起始位置 buffer 到 pSave指针指示位置的前一位
/*--------------------------------------------------------------------------*/
